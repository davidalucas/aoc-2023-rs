...
fn sum_digits_returns_expected_result_for_example() {
    let result = trebuchet::sum_digits("./src/day_1/example1.txt");
...
fn sum_digits_enhanced_returns_expected_result_for_example() {
    let result = trebuchet::sum_digits_enhanced("./src/day_1/example2.txt");
    assert_eq!(result, 281);
}

#[test]
fn sum_digits_enhanced_returns_expected_result_for_data() {
    let result = trebuchet::sum_digits_enhanced("./src/day_1/data.txt");
